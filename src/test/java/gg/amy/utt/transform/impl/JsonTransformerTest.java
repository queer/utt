...
public class JsonTransformerTest {
    ...
    public void testJsonIdentityTransformation() {
        final var input = """
                ...
                """;
        final var ctx = new TransformationContext(InputFormat.JSON, OutputFormat.JSON, null, null);
    ...
    public void testXmlToJsonTransformation() {
        final var input = """
                ...
                """;
        final var ctx = new TransformationContext(InputFormat.XML, OutputFormat.JSON, null, null);
