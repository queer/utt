...
public class TomlTransformerTest {
    ...
    public void testTomlIdentityTransformation() {
        final var input = """
                ...
                """;
        final var ctx = new TransformationContext(InputFormat.TOML, OutputFormat.TOML, null, null, false);
    ...
    public void testXmlToJsonTransformation() {
        final var input = """
                ...
                """;
        final var ctx = new TransformationContext(InputFormat.XML, OutputFormat.TOML, null, null, false);
