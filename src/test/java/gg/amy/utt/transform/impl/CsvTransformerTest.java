...
public class CsvTransformerTest {
    ...
    public void testCsvIdentityTransformation() {
        final var input = """
                ...
                """;
        final var ctx = new TransformationContext(InputFormat.CSV, OutputFormat.CSV, null, null);
    ...
    public void testJsonToCsvTransformation() {
        final var input = """
                ...
                """;
        final var ctx = new TransformationContext(InputFormat.JSON, OutputFormat.CSV, null, null);
