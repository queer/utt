...
public class YamlTransformerTest {
    ...
    public void testYamlIdentityTransformation() {
        final var input = """
                ...
                """;
        final var ctx = new TransformationContext(InputFormat.YAML, OutputFormat.YAML, null, null, null, false);
    ...
    public void testXmlToYamlTransformation() {
        final var input = """
                ...
                """;
        final var ctx = new TransformationContext(InputFormat.XML, OutputFormat.YAML, null, null, null, false);
