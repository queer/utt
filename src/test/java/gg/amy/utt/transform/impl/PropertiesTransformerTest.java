...
public class PropertiesTransformerTest {
    ...
    public void testPropertiesIdentityTransformation() {
        final var input = """
                ...
                key.nested=value
                """;
        final var ctx = new TransformationContext(InputFormat.PROPERTIES, OutputFormat.PROPERTIES, null, null);
    ...
    public void testXmlToPropertiesTransformation() {
        final var input = """
                ...
                """;
        final var ctx = new TransformationContext(InputFormat.XML, OutputFormat.PROPERTIES, null, null);
